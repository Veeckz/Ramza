...
try{
	...
	if($conexionMysqli->connect_errno)
	{
		...
		$query= utf8_decode("Insert into Tbl_Productos (ID_Producto, Nombre, Color, Tamaño, Tipo, Modelo, Cantidad_Disponible, Descripcion) values (".$ID_Producto.", '".$Nombre."', '".$Color."', '".$Tamaño."', '".$Tipo."', '".$Modelo."', ".$Cantidad_Disponible.", '".$Descripcion."')");
