...
try{
	...
	if($conexionMysqli->connect_errno)
	{
		...
		$query= utf8_decode("Insert into Tbl_Productos (Nombre, Color, Tamaño, Tipo, Modelo, Cantidad_Disponible, Descripcion, Precio) values ('".$Nombre."', '".$Color."', '".$Tamaño."', '".$Tipo."', '".$Modelo."', ".$Cantidad_Disponible.", '".$Descripcion."', ".$Precio.")");
