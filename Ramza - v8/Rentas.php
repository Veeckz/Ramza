...
try{
	...
	if($conexionMysqli->connect_errno)
	{
		...
		$query= utf8_decode("Insert into Tbl_Renta (ID_Cliente, Fecha_Inicial_De_Apartado, Fecha_De_Entrega, Fecha_Recuperacion, Total) values (".$ID_Cliente.", '".$Fecha_Inicial_De_Apartado."', '".$Fecha_De_Entrega."', '".$Fecha_Recuperacion."', ".$Total.")");
		...
		if ($resultadoOperacion) 
		{
			...
			<div class="text-success text-center">
				<font color='blank'><p> Operaci&oacute;n Realizada con &eacute;xito </p></font>
			<div>
