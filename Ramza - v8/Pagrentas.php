            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="mon2">
                        <a href="" class="btn btn-default" id="menu-toggle">Bienvenido: Registro Rentas</a>
	...
	<div class="contenedor">
            ...
            <div class="col-md-6 col-md-offset-3 wow fadeInUp" data-wow-delay=".3s">
                    ...
                    <div class="col-md-6 col-xs-12 text-left">
                        <input type="text" class="form-control" id="ID_Cliente" placeholder="ID Cliente">
                    </div>
                    <div class="col-md-6 col-xs-12 text-left">
                    ...
                    <center><button type="submit" class="btn btn-success" onclick="validarRenta()"><span class="glyphicon glyphicon-save"></span>Guardar</button>
                </center>
            </div>
        </div>
</div>
...
<script src="js/ValidacionRenta.js" type="text/javascript"> </script>
<div id="map3">
</div>
